...
#define X1_QNET_ATTACH_POINT "/net/RMIT_BBB_v5_09/dev/name/local/x1_group_14" // X1 Remote attach point
#define C1_QNET_ATTACH_POINT "/net/RMIT_BBB_v5_03/dev/name/local/c1_group_14" // C1 Remote attach point
